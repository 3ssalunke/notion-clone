  ...
  return (
    <>
        ...
        <div className="overflow-hidden flex after:content[''] after:dark:from-brand-dark after:to-transparent after:from-background after:bg-gradient-to-l after:right-0 after:bottom-0 after:top-0 after:w-20 after:z-10 after-absolute before:content[''] before:dark:from-brand-dark before:to-transparent before:from-background before:bg-gradient-to-r before:left-0 before:bottom-0 before:top-0 before:w-20 before:z-10 before-absolute">
          {[...Array(2)].map((_, index) => (
            <div key={index} className="flex flex-nowrap animate-slide">
              {CLIENTS.map((client) => (
                <div key={client.alt}>
                  <div className="relative w-[200px] m-20 shrink-0 flex items-center">
                    <Image
                      src={client.logo}
                      alt={client.alt}
                      width={200}
      ...
      <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
        <div className="w-[30%] blur-[120px] rounded-full h-32 absolute bg-brand-primaryPurple/50 -z-10 top-20" />
        <TitleSection
                  ...
                  cardHeader={
                    <div className="flex items-center gap-4">
                      <Avatar
                        ...
                        fallback={<AvatarFallback>AV</AvatarFallback>}
                      />
                      <div>
      ...
      <section className="mt-20 px-4 sm:px-6">
        <TitleSection
          ...
          subheading="Experience all the benefits of our platform. Select a plan tha suits your needs and take your productivity to new heights"
          pill="Pricing"
        />
